...
foreach($_POST['data'] as $k=>$v){
	if(trim($v) != ""){
		$bdb->query("INSERT INTO ".PREFIX."_index (resource_id, resource_type, resource_tv, content)VALUES('".mysql_real_escape_string($_POST['id'])."','page', '".mysql_real_escape_string($k)."', '".mysql_real_escape_string(preg_replace('{<.*?>|\s}is', ' ', $v))."')");		
	}
}
//Globals
