/*
Slightly modified by Senica Gonzalez
Usage: jQuery(selector).beautify({
	indent_character="\t",
	indent_size=1,
	max_char=100,
	brace_style="{",
...
(function( $ ){
	$.fn.beautify = function(obj) {
		...
		return style_html(jQuery(this).html(), obj.indent_size, obj.indent_character, obj.max_char, obj.brace_style);
	};
})(jQuery);